...
%These are slides for a 20 minute presentation aimed at incoming PSI masters students, explaining some of the work I've been doing in the last few years.  The goal is to give a sense of what the work is about, and why it is interesting, without going into technical details.  I'm aiming for a fairly light tone.
...
\begin{frame}
I thought that what I was working on $\approx$20 years ago was {\bf almost commutative algebras}: non-commutative algebras that become commutative in a limit.  
\begin{block}{}
...
\begin{itemize}
  ...
  \item<2-> All of the examples I was studying occurred this way!
  \item<3-> If you have a 3d theory with $\mathcal{N}=4$ supersymmetry, it has two natural classes of topological twists $Q_{\color{red} A}$ and $Q_{\color{blue} B}$, and thus two hyperk\"ahler manifolds associated to it:   the {\bf \color{red} Coulomb}  and {\bf \color{blue} Higgs} branches.
\end{itemize}
\end{frame}
\begin{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Given a knot $K\subset M$ and a representation $V$ of $G$, we can define the Wilson loop observable $W_{K,V}$, which is an expected value of the trace of the holonomy of the connection around $K$ in the representation $V$.
  \end{itemize}  
  \end{block}  
